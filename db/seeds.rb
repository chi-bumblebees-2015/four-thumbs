...
user1 = User.create(name: "user1", password: "superdogs", email: "test@gmail.com")
user2 = User.create(name: "user2", password: "superdogs", email: "test2@gmail.com")
user3 = User.create(name: "user3", password: "superdogs", email: "test3@gmail.com")
